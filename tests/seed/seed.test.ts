...
describe('seed job', () => {
  ...
  it('persists ISINs for the instruments that declare one', async () => {
    ...
    expect(rows.map((r) => [r.id, r.isin])).toEqual([
      ...
      ['NSE:BAJFINANCE', 'INE296A01024'],
      ['NSE:BRITANNIA', 'INE216A01030'],
      ['NSE:COFORGE', 'INE591G01017'],
      ['NSE:DIXON', 'INE935N01020'],
      ['NSE:DMART', 'INE192R01011'],
      ['NSE:GODREJCP', 'INE102D01028'],
      ['NSE:GOLDBEES', 'INF732E01029'],
      ['NSE:HDFCBANK', 'INE040A01034'],
      ['NSE:HINDUNILVR', 'INE030A01027'],
      ['NSE:ICICIBANK', 'INE090A01021'],
      ['NSE:INFY', 'INE009A01021'],
      ['NSE:ITC', 'INE154A01025'],
      ['NSE:KAJARIACER', 'INE217B01036'],
      ['NSE:KOTAKBANK', 'INE237A01028'],
      ['NSE:LIQUIDBEES', 'INF732E01011'],
      ['NSE:LT', 'INE018A01030'],
      ['NSE:LTIM', 'INE214T01010'],
      ['NSE:MARUTI', 'INE585B01010'],
      ['NSE:MPHASIS', 'INE356A01018'],
      ['NSE:NESTLEIND', 'INE239A01016'],
      ['NSE:NIFTYBEES', 'INF732E01037'],
      ['NSE:NYKAA', 'INE388Y01029'],
      ['NSE:PAYTM', 'INE982J01020'],
      ['NSE:PERSISTENT', 'INE262H01013'],
      ['NSE:PGHH', 'INE179A01014'],
      ['NSE:POLICYBZR', 'INE417T01026'],
      ['NSE:RELIANCE', 'INE002A01018'],
      ['NSE:RPOWER', 'INE000A01010'],
      ['NSE:SBIN', 'INE062A01020'],
      ['NSE:SMALLCASE-RESIDUE', 'INE000A01010'],
      ['NSE:SUNPHARMA', 'INE044A01036'],
      ['NSE:SUPREMEIND', 'INE195A01028'],
      ['NSE:TCS', 'INE467B01029'],
      ['NSE:TITAN', 'INE280A01028'],
      ['NSE:TRENT', 'INE849A01020'],
      ['NSE:ZOMATO', 'INE758T01015'],
    ]);
  });
