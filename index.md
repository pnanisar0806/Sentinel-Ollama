...
| `migrations/0018_cash_ceiling_rail.sql` | owner amendment 2026-09-19: inserts `cash_ceiling_pct = 10` and deletes the legacy dotted-and-fraction `cash.ceiling = 0.2` key, so `settings_rails` carries one key in one unit |
